...
$sql1 = "SELECT tot_training_hrs,remarks FROM tbl_training_master WHERE user_id=$employee_id AND training_year=$select_year";
...
function fetchUserIds($moduleId, $userId, $individualAccess)
{
    ...
    if (!empty($orConditions)) {
        ...
        $mergedArray = array_merge($userIds, $accessIds);
        ...
        // Remove duplicate user IDs and convert to a comma-separated string
...
function today_audited($user_id, $date_report) {
    ...
    $sql1 = "SELECT remarks,action,page_type,jobdiary_date,DATE_FORMAT(log_date,'%h:%i %p') as log_time,u.full_name from tbl_employee_log l left join tbl_users u on u.user_id = l.user_id where access_id = $user_id and date(jobdiary_date) = '$date_report' and l.user_id>0 and access_id!=l.user_id and   (page_type!= 'Monthly Plan' and page_type!= 'Monthly Plan D&R')  order by date(jobdiary_date) ";
    ...
    <div id="remarks_by">
        <table id="customers_time" class="reviewed_by" style="border-collapse: collapse;
            ...
            <tr>
                <td colspan="8" align="center"><div style="display: block;
                                                    "><font color="#ff0000;" size="+1"><strong>Reviewed By</strong>&nbsp;</font></div></td>
            </tr>
            <tr height = "30" style = "border:#a6107b solid 1px; background-color:#e2f3fd">
                <td align = "left" style = "border:#000000 solid 1px;text-indent:5px"><b><font color = "#a6107b" size = "2" face = "Verdana, Arial, Helvetica, sans-serif">Type</font></b></td>
                <td align = "left" style = "border:#000000 solid 1px;text-indent:5px"><b><font color = "#a6107b" size = "2" face = "Verdana, Arial, Helvetica, sans-serif">Time</font></b></td>
                <td align = "left" style = "border:#000000 solid 1px;text-indent:5px"><b><font color = "#a6107b" size = "2" face = "Verdana, Arial, Helvetica, sans-serif">Superior Name</font></b></td>
            </tr>
            <?php
            $count = 0;$old_time="";
            while ($row6 = $mysql1->fetch_assoc()) {
                ...
                <tr height="20" style="border:#a6107b solid 1px; background-color:<?php echo $bgcolor ?>">
                    <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['page_type']; ?></b></font></td>
                    <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php  echo $row6['log_time']; ?></b></font></b></font></td>
                    <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['full_name']; ?></b></font></td>
                </tr>
...
function today_auditing($user_id, $date_report) {
    ...
    $sql1 = "SELECT  l.page_type,jobdiary_date,DATE_FORMAT(log_date,'%h:%i %p') as log_time,u.full_name from tbl_employee_log l   left join  tbl_users u on u.user_id=l.access_id  where l.user_id=$user_id and date(log_date) = '$date_report'  and access_id>0 and access_id!=l.user_id and (page_type!= 'Monthly Plan' and page_type!= 'Monthly Plan D&R')   order by date(log_date) ";

    $mysql1 = $mysqli->query($sql1);
    if ($mysql1->num_rows == 0)
        return false;
    ?>
    <table id="customers_time" class="reviewed_to" style="border-collapse: collapse;" width="90%" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="8" align="center"><div style="display: block;"><font color="#ff0000" size="+1"><strong>Reviewed To</strong></font></div></td>
        </tr>
        ...
        <tr height="30" style="border:#a6107b solid 1px; background-color:#e2f3fd">
            ...
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Type</font></b></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Time</font></b></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Subordinate Name</font></b></td>
        </tr>
        ...
        while ($row6 = $mysql1->fetch_assoc()) {
            ...
            <tr height="20" style="border:#a6107b solid 1px; background-color:<?php echo $bgcolor ?>">
                ...
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['page_type']; ?></b></font></td>
                <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['log_time']; ?></b></font></td>
...
function thisMonthaudited($user_id, $month, $year) {
    ...
    $sql1 = "SELECT  remarks,action,page_type, DATE_FORMAT( jobdiary_date, '%M' ) month,DATE_FORMAT(log_date,'%d/%m/%Y %h:%i %p') as log_time,u.full_name from tbl_employee_log l left join  tbl_users u on u.user_id=l.user_id  where access_id=$user_id and action = 'Monthly Plan Review' and ((MONTH(log_date) = '$month' AND YEAR(log_date) = '$year') || (MONTH(jobdiary_date) = '$month' AND YEAR(jobdiary_date) = '$year')) and l.user_id>0 and access_id!=l.user_id order by date(log_date) DESC limit 10";
    ...
    <table  id="customers_time" class="reviewed_by" style="border-collapse: collapse;" width="90%" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="30" style="border:#a6107b solid 1px; background-color:#e2f3fd">
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Type</font></b></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Reviewed Month</font></b></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Reviewed On</font></b></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Superior Name</font></b></td>
        </tr>
        <?php
        $count = 0;
        while ($row6 = $mysql1->fetch_assoc()) {
            ...
            <tr height="20" style="border:#a6107b solid 1px; background-color:<?php echo $bgcolor ?>">
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['page_type']; ?></b></font></td>
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['month']; ?></b></font></td>
                <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['log_time']; ?></b></font></b></font></td>
                <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['full_name']; ?></b></font></td>
            </tr>
            <?php
...
function thisMonthaudited_to($user_id, $month, $year) {
    ...
    $sql1 = "SELECT  remarks,action,page_type, DATE_FORMAT( jobdiary_date, '%M' ) month,DATE_FORMAT(log_date,'%d/%m/%Y %h:%i %p') as log_time,u.full_name
...
if(o.subordinate_id>0,concat(t.type,' to ',u1.full_name),t.type)  as  type ,
o.observation,
...
and o.report_year=" . $plan_year;
  ...
  // echo $sql_fetch;exit;
    ...
    if ($mysql1->num_rows == 0)
        return false;
    ?>
    <table id="customers_time" class="observation_to" style="border-collapse: collapse;" width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="12" align="center"><div style="display: block;"><font color="#ff0000">&nbsp;<b></b></font></div></td>
        </tr>

        <tr height="30" style="border:#a6107b solid 1px; background-color:#e2f3fd">

            <td colspan="2" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Reviewed To</b></font></td>
            ...
            <td colspan="2" align="center" style="border:#000000 solid 1px;"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b> Reviewed On</b></font></td>
            <?php if($type!="monthly"){?>
            <td colspan="2" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Job Diary Date </b></font></td>
            <?php }?>
            <td colspan="4" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Remarks</b></font></td>
            <td colspan="3" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>User Response</b></font></td>
            <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Notified</b></font></td>
        </tr>
        ...
        while ($row6 = $mysql1->fetch_assoc()) {
            ...
            <tr height="30" style="border:#a6107b solid 1px; background-color:<?php echo $bgcolor ?>">
                ...
                <?php  if ($type == 'monthly') {?>
                <td colspan="2" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                        <a href="javascript:openWindow('monthly_plan_history_new.php?select_employee_id=<?php echo $row6['user_id'] ?>&plan_month=<?php echo $plan_month ?>&plan_year=<?php echo $plan_year ?>','view_status');">         <?php echo $row6['full_name']; ?></a></b></font></td>
                <?php } else{ ?>
                  <td colspan="2" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                         <?php echo $row6['full_name']; ?> </b></font></td>
                <?php }?>
                ...
                <td colspan="2" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                        <?php echo $row6['audit_date']; ?></b></font></td>
                        <?php if($type!="monthly"){?>
                        <td colspan="2" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                        <?php echo $row6['report_date']; ?></b></font></td>
                        <?php }?>
                <td colspan="4" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                        <?php echo nl2br($row6['remarks']); ?></b></font></td>
                <td colspan="3" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo nl2br($row6['user_remarks']); ?></b></font></td>
...
// echo $sql_fetch;
    ...
    ?>
    <div id="remarks_by">
        <table id="customers_time" class="observation" style="border-collapse: collapse; " width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="13" align="center"><div style="display: block;"><font color="#ff0000">&nbsp;<b></b></font></div></td>
            </tr>

            <tr height="30" style="border:#a6107b solid 1px; background-color:#e2f3fd">

                <td colspan="2" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Reviewed By</b></font></td>
                <td colspan="4" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Rating</b></font></td>
                <td colspan="2" align="center" style="border:#000000 solid 1px;"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b> Date</b></font></td>
            ...
            while ($row6 = $mysql1->fetch_assoc()) {
                ...
                <tr height="30" style="border:#a6107b solid 1px; background-color:<?php echo $bgcolor ?>">
                    ...
                    <td colspan="4" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                            <?php echo nl2br($row6['remarks']); ?></b></font></td>
                    <td colspan="3" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                            <?php echo nl2br($row6['user_remarks']); ?></b></font></td>
                    <td align="left" style="border:#000000 solid 1px;text-indent:5px">
                        <?php
                        if ($row6['notified'] == 1) {
                            ?>
    ...
    if ($user_id != $current_user_id) {
        ...
        <table style="border-collapse: collapse;" width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
            <tr height="25" style="border:#a6107b solid 1px;background-color:#008080;color:#ffffff;">
                <td colspan="10" align="center"><b>Review Findings</b></td></tr>
            <tr style="border:#a6107b solid 1px;background-color:#ffffff">
                ...
                <td style="border:#a6107b solid 1px;background-color:#ffffff">
                    <b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                        ...
                        <td id="obs_cat" style="border:#a6107b solid 1px;background-color:#ffffff;display: none" rowspan="3">
                            
                            &nbsp; &nbsp;<select id="ob_type" required="required" name="ob_type" style="font-family:sans-serif;font-weight: bold ;display: none">  
                ...
                <td align="center" style="border:#a6107b solid 1px;background-color:#ffffff" rowspan="3"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Remarks</font></b><br />
                    <textarea style="border:2px solid skyblue;margin:10px;" id="remarks" name="remarks" rows="5" cols="30"></textarea></td>
            </tr>
            <tr style="border:#a6107b solid 1px;background-color:#ffffff">
            ...
            <tr style="border:#a6107b solid 1px;background-color:#ffffff">
                ...
                <td>
                    <b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="4">
                        &nbsp;<input id="ncr" type="radio" name="observation" value="2">&nbsp;N.C.R</font></b></td>
            </tr>

            <tr height="25" style="border:#a6107b solid 1px;background-color:#e9e9e9">
                <td colspan="10" align="center">
                    <input class="jobdiary_buttons" type="submit" onclick="return validate();" name="submit_audit" value="Submit" /></td>
                ...
                <!--<td colspan="2" rowspan="3" align="left" rowspan="3">-->
                    ...
                    <tr style="border:#a6107b solid 1px;background-color:#ffffff">
                        ...
                        <td style="border:#a6107b solid 1px;background-color:#ffffff">
                         ...
                         <b><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="red">
                        <input id="ncr" type="radio" name="observation" value="2">N.C.R</font></b></td>
               
            </tr>
            <tr height="25" style="border:#a6107b solid 1px;background-color:#e9e9e9">
                <td colspan="10" align="center">
                    <input class="jobdiary_buttons" type="submit" id="ms" onclick="return validate();" name="submit_audit2" value="Submit" /></td>
...
values (" . $audit_employee_head . ",'" . trim(addslashes($remarks)) . "','" . $rating . "','daily','$log_date','" . $date_report . "'," . $audited . "," . $user_id . ")";
        ...
        if ($remarks != "") {
            ...
            $audit_user_query = $mysqli->query("select full_name,email,personal_email from tbl_users  where user_id=$audit_employee_head");
            ...
            $user_query = $mysqli->query("select full_name,email,personal_email from tbl_users  where user_id='$audited'");
            ...
            $subordinate_query = $mysqli->query("select full_name from tbl_users  where user_id=$user_id");
...
/*@include_once 'PHPMailer/class.phpmailer.php';
        ...
        $sub_sql = "select username,full_name,division_head from tbl_users where  user_id=$audit_employee_head";
...
function get_user_details_table($user_id, $my_division_head) {
    ...
    global $mysqli;
    $user_info_query = $mysqli->query("select  user.photo,user.hr_id,user.employee_code, user.work_category,user.username, user.full_name, user.designation, user.gender, DATE_FORMAT(user.dob,'%d-%b-%Y') as dob, DATE_FORMAT(user.doj,'%d-%b-%Y') as doj,DATE_FORMAT(user.gdoj,'%d-%b-%Y') as  gdoj,user.personal_email,user.email, user.mobile, user.hourly_rate,user.currency, user.emp_company_id, user.emp_division_id, user.emp_subdivision_id,emp_group_name,t.name as job_type,work_place, user.status, user.is_regular,user.date_created,user.user_height, user.blood_group,user.reporting_time,head.full_name as division_head_name,user.division_head,
    
round(
(
(DATEDIFF(now(),user.gdoj)-user.service_break_days)
/365
...
where user.user_id=$user_id");
    ...
    $tree_sql = "SELECT full_name,user_id  FROM  tbl_users WHERE  division_head='" . $user_id . "' and is_regular=1 and status='Active' order by full_name";
 ...
 round(qi.plustwo+qi.diploma+ qi.ug+qi.pg+qi.computer+qi.othrs+ (round((datediff(now(),u.GDOJ)/365.25),2)*2)+ qi.relnt+(( qi.total- qi.relnt)/4),2) as emp_index
...
");
    ...
    <table width="99%" border="0" cellpadding="0" cellspacing="0"  style="border-collapse:collapse">
        <tr height="20" style="border:#a6107b solid 1px;">
            <td rowspan="6"   bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><img width="100px" src="images/employee/<?php echo $user_info_row['photo'] ?>">&nbsp;</td>
            <td   bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Name
           <br>&nbsp;Employee Code</font></b>
            </td>
            <td width="198" align="left" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['full_name'] ?>&nbsp;
            <br>&nbsp;<?php echo $user_info_row['employee_code'] ?></font></b>
            </td>
            <td width="198" align="left" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">Email</font></b></td>
            <td width="198" align="left" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;">&nbsp;<b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="mailto:<?php echo $user_info_row['email'] ?>"><?php echo $user_info_row['email'] ?></a>&nbsp;&nbsp;
                    <?php
                    if ($user_info_row['personal_email'] != $user_info_row['email']) {?>
                    <a href="mailto: <?php echo $user_info_row['personal_email'];?>" > &nbsp;<?php echo $user_info_row['personal_email'];?></a>
                  <?php   }
                    ?>
                    </font></b></td>
...
<!--              <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Employee Code</font></b></td>
            ...
            <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Designation</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['designation'] ?></font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">Mobile</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['mobile'] ?></font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Date of Joining</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['doj'] ?></font></b></td>
        </tr>
        <tr height="20" style="border:#a6107b solid 1px;">
            <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Hourly Rate</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['hourly_rate'] . " " . $user_info_row['currency'] ?></font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">Gender</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['gender'] ?></font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd">
                <b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Group Joining Date</font></b>
          <hr>  <b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Years in Aries</font>:</b>
          <hr>   <b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Emp Index</font>:</b>
            </td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd">
                <b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['gdoj'] ?></font></b>
            <hr>
           <b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['year_in_aries'] ?></font></b>
               <hr>   <b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php if (isset($index_row['emp_index'])) echo $index_row['emp_index'] ?></font></b>
        ...
        <tr height="20" style="border:#a6107b solid 1px;">
            <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Comp/Div/SubDiv</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $dimension_array[$user_info_row['emp_company_id']] ?>&nbsp;&nbsp;<?php echo $dimension_array[$user_info_row['emp_division_id']] ?>&nbsp;&nbsp;<?php echo $dimension_array[$user_info_row['emp_subdivision_id']] ?></font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Work Category</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $work_category_array[$user_info_row['work_category']] ?></font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Work Location</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['work_place'] ?></font></b></td>
        </tr>
        <tr height="20" style="border:#a6107b solid 1px;">
            <td bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Reporting To</font></b></td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd">&nbsp;<?php
                if ($my_division_head != $user_info_row['division_head']) {
                    ?>
                    <b>
                        <a href="javascript:click_tree(<?php echo $user_info_row['division_head'] ?>)"  style='text-decoration:underline;color:#0000FF'  face='Verdana, Arial, Helvetica, sans-serif' size='2'  ><?php echo $user_info_row['division_head_name'] ?></a></b>
                    <?php
                } else {
                    ?>
                    <b>
                        <font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">
                        <?php echo $user_info_row['division_head_name'] ?></font></b>
                    <?php
                }
                ?>
            </td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Reporting Time</font></b></td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['reporting_time'] ?></font></b></td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Job Type</font></b></td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['job_type'] ?></font></b></td>
        </tr>
        <tr height="20" style="border:#a6107b solid 1px;">
            <td bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Review Tree</font></b></td>
...
round(
(
(DATEDIFF(ex.date,user.gdoj)-user.service_break_days)
/365
...
<!--              <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Employee Code</font></b></td>
        ...
        <tr height="20" style="border:#a6107b solid 1px;">
          ...
          <hr>   <b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Emp Index</font>:</b>
            ...
            <hr>
           <b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2"><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['year_in_aries'] ?></font></b>
               <hr>   <b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $index_row['emp_index'] ?></font></b>
        ...
        <tr height="20" style="border:#a6107b solid 1px;">
            ...
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;LAST DAY</font></b></td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo date('d-m-Y',strtotime($user_info_row['date'])) ?></font></b></td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Job Type</font></b></td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['job_type'] ?></font></b></td>
        </tr>
        <tr height="20" style="border:#a6107b solid 1px;">
...
//*****************End efficiency calculation************
	...
	user.work_category,if(user.u_confirm_name!='',user.u_confirm_name,user.full_name) as full_name, user.designation, user.gender,user.gdoj,user.original_dob , if(user.original_dob!='0000-00-00',DATE_FORMAT(user.original_dob,'%d-%b-%Y'),DATE_FORMAT(user.dob,'%d-%b-%Y')) as sdob,
round(
(
(DATEDIFF(now(),user.gdoj)-user.service_break_days)
/365
...
as year_in_aries,duties.is_locked,sum(e.Basic_Salary+e.Food_Allowance+e.House_Allowance+e.Fixed_Overtime+e.Mobile_Allowance+e.Car_Allowance+e.Petrol_Allowance+e.Fixed_Incentive+e.Child_Education+e.Traveling_Allowance+e.Target_Allowance+e.Other_Allowance+e.conveyance+e.parent_allowance+e.special_allowance)as gross,

DATE_FORMAT(user.dob,'%d-%b-%Y') as dob, DATE_FORMAT(user.doj,'%d-%b-%Y') as doj,DATE_FORMAT(user.gdoj,'%d-%b-%Y') as  gdoj,user.personal_email,user.email, CONCAT(user.mobile,'<br>',user.personal_mobile) as mobile, user.hourly_rate,user.currency, user.emp_company_id, user.emp_division_id, user.emp_subdivision_id,emp_group_name,t.name as job_type,work_place, user.status, user.is_regular,user.date_created,user.user_height, user.blood_group,user.reporting_time,
if(head.u_confirm_name!='',head.u_confirm_name,head.full_name)as division_head_name,
...
where user.user_id=$user_id");
    ...
    $user_info_row = $user_info_query->fetch_assoc();
    $tree_sql = "SELECT if(u_confirm_name!='',u_confirm_name,full_name) full_name,user_id  FROM  tbl_users WHERE  division_head='" . $user_id . "' and is_regular=1 and status='Active' order by full_name";
    $tree_result = $mysqli->query($tree_sql);
...
//   echo $dob = $original_dob!="0000-00-00"?$original_dob:$dob;
       ...
       //*****FOR BIRTHDAY*******//
        ...
        if($curr_month==$birth_month&&$c_today==$birth_day){ 
          ...
          $chk_sql = $mysqli->query("SELECT * FROM tbl_observations WHERE audited_by=$current_user_id and user_id=$user_id and observation=21");//Added ON 26-4-22 TO HIDE THE BDAY MSG IF WISHED ALREADY
    ...
    <table width="99%" border="0" cellpadding="0" cellspacing="0"  style="border-collapse:collapse">
<tr height="20" style="border:#a6107b solid 1px;">
<td rowspan="7"   bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><img width="100px" src="images/employee/<?php echo $user_info_row['photo'] ?>">&nbsp;
<br><br><br>
&nbsp;<a class='iframe1' href='../profile-completed.php?employee_id=<?php echo $user_info_row['user_id'] ?>'><input type="button" class="btn btn-warning btn-xs btn-round" value="View Profile" style="font-weight:600;">
</a>
<?php //if($_SESSION['user_id']==103){?>
<?php if($user_info_row['is_complete']==1){ ?>
<br><br><button class="btn btn-success btn-xs ">Completed on <?php echo date('d-m-y',strtotime($user_info_row['updated_date'])) ?></button>
...
<?php }//}?>
 ...
 <td   bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Name
            ...
            <td width="198" align="left" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['full_name'] ?>&nbsp;
                    ...
                    </font></b><?php if($current_user_id==83||$current_user_id==19||$current_user_id==49||$current_user_id==48||$current_user_id==52||$current_user_id==1452||$current_user_id==3272||$current_user_id==10||$current_user_id==2||$current_user_id==38||$current_user_id==36 || $current_user_id==103 || $current_user_id==512 ){?>  <a class='iframe1' href='employee_hr_data.php?user_id=<?php echo $user_id?>'><img src='images/view_emp_details.png'  title='View History' /></a><?php }?></td>
            <td width="198" align="left" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Email</font></b></td>
            <td width="198" align="left" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;">&nbsp;<b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $user_info_row['email'] ?>&nbsp;&nbsp;
                    <?php
                    if ($user_info_row['personal_email'] != $user_info_row['email']) {
            ...
            <td  rowspan="6" align="center" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;">
                ...
                Happiness Level is </strong><?php print($happiness);?> (<?= round($row_total_happiness['avg_level'])?>%)
					...
					<a href="view-happiness-index.php?user_id=<?php echo $user_id;?>" class="iframe1"> Click here to view assessment</a></center>
        ...
        <tr height="20" style="border:#a6107b solid 1px;">
            <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Designation</font></b>
                <br /></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['designation'] ?></font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Mobile</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $user_info_row['mobile'] ?></font></b></td>
        ...
        <tr height="10" style="border:#a6107b solid 1px;">
            <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Duties & Responsibilities</font></b>
            </td> 
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"> 
        ...
        <!--</script>-->
                 ...
                 <td width="198" align="left" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Teams ID</font></b></td>
            <td width="198" align="left" bgcolor="#e2f3fd"   style="border:#000000 solid 1px;"><b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $user_info_row['teams_id'] ?>
                    <?php
        ...
        <tr height="20" style="border:#a6107b solid 1px;">
            ...
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['currency']." ". $user_info_row['hourly_rate']   ?></font></b>
           ...
           <b> Gross Salary : <?php echo $user_info_row['currency']." ".  number_format($user_info_row['gross']);    ?> </b></font>
            <?php }?>
            </td>
            ...
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Work Category</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $work_category_array[$user_info_row['work_category']] ?></font></b></td>
            <!--<td width="4%" style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Remainder</font></b></td>-->
        </tr>
        ...
        <tr height="20" style="border:#a6107b solid 1px;">
            <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Years in Aries</font></b><br /><b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Emp Index</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $user_info_row['year_in_aries'] ?></font></b><br />
                <b><font color="#FF0000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php if(isset($index_row)) echo $index_row['emp_index'] ?></font></b>
            </td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Work Location</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $user_info_row['work_place'] ?></font></b></td>
        </tr>
        <tr height="20" style="border:#a6107b solid 1px;">
            <td  bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Comp/Div/SubDiv</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;<?php echo $dimension_array[$user_info_row['emp_company_id']] ?>&nbsp;&nbsp;<?php echo $dimension_array[$user_info_row['emp_division_id']] ?>&nbsp;&nbsp;<?php echo $dimension_array[$user_info_row['emp_subdivision_id']] ?></font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Employee Type</font></b></td>
            <td align="left"   style="border:#000000 solid 1px;" bgcolor="#e2f3fd"><b>&nbsp;</b></font><b><font color="#000000" face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $user_info_row['job_type'] ?></font></b></td>
        </tr>
        <tr height="20" style="border:#a6107b solid 1px;">
            <td bgcolor="#e2f3fd"  style="border:#000000 solid 1px;"><b><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp;Reporting To</font></b></td>
            <td align="left"  style="border:#000000 solid 1px;" bgcolor="#e2f3fd">&nbsp;<?php 
        ...
        <tr   style="border:#a6107b solid 1px;"><td colspan="6" bgcolor="#e2f3fd"> 
                <img src="images/award.gif" width="50" height="50"><i style="font-size:18px;color: #9C4DEA"><?php echo $compltedyears?></i>&nbsp;&nbsp;<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#congModal">
  Say Congrats
</button>
    </td>
        </tr><?php }?>
        ...
        <tr   style="border:#a6107b solid 1px;"><td colspan="6" bgcolor="#e2f3fd"> 
                <img src="images/bday.gif" width="50" height="50"><i style="font-size:18px;color: #E33DB2"><?php echo $birthday?></i>&nbsp;&nbsp;<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#wishesModal">
  Send Wishes
</button>
    </td>
        </tr><?php }?>
...
function get_user_details($user_id) {
   ...
   //echo "select  user.username,is_lock,user.full_name,user.division_head  from tbl_users user where user.user_id=$user_id";
    $user_info_query = $mysqli->query("select  user.username,is_lock,user.full_name,user.division_head  from tbl_users user where user.user_id=$user_id");
    $user_info_row = $user_info_query->fetch_assoc();
...
function get_lock_type($type_id) {
    global $mysqli;
    $lock_sql = "SELECT type FROM  tbl_lock_types  where id=$type_id";

    $lock_result = $mysqli->query($lock_sql);
    $lock_row = $lock_result->fetch_assoc();
    return $lock_row['type'];
}
function self_reviewed_to($user_id) {
    global $mysqli;

    $sql1 = "SELECT  l.page_type,jobdiary_date,DATE_FORMAT(log_date,'%h:%i %p') as log_time,u.full_name from tbl_employee_log l  "
    ...
    <table id="customers_time" class="reviewed_to" style="border-collapse: collapse;" width="90%" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="30" style="border:#a6107b solid 1px; background-color:#e2f3fd">
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Type</font></b></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">For the Month</font></b></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Time</font></b></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Subordinate Name</font></b></td>
        </tr>
        ...
        while ($row6 = $mysql1->fetch_assoc()) {
            ...
            <tr height="20" style="border:#a6107b solid 1px; background-color:<?php echo $bgcolor ?>">
                ...
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['page_type']; ?></b></font></td>
                <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo date("M-Y",strtotime( $row6['jobdiary_date'])); ?></b></font></td>
                <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo date("d-M-Y",strtotime($row6['jobdiary_date']))."--". $row6['log_time']; ?></b></font></td>
...
where o.audited_by=" . $user_id;
    ...
    <table id="customers_time" class="observation_to" style="border-collapse: collapse;" width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="30" style="border:#a6107b solid 1px; background-color:#e2f3fd">
            ...
            <td  align="left" style="border:#000000 solid 1px;"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Reviewed To</b></font></td>
            <!--<td colspan="4" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Rating</b></font></td>-->
            <td  align="center" style="border:#000000 solid 1px;"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b> Date</b></font></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Remarks</b></font></td>
            <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>User Response</b></font></td>
            <td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Notified</b></font></td>
        </tr>
        ...
        while ($row6 = $mysql1->fetch_assoc()) {
            ...
            <tr height="30" style="border:#a6107b solid 1px; background-color:<?php echo $bgcolor ?>">
                ...
                <td align="left" style="border:#000000 solid 1px;"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                        <?php echo $row6['full_name']; ?></b></font></td>
...
<!--                <td style="border-left-style:hidden">
                ...
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                        <?php echo $row6['audit_date']; ?></b></font></td>
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                        <?php echo nl2br($row6['remarks']); ?></b></font></td>
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
    ...
    <div id="remarks_by">
        <table id="customers_time" class="observation" style="border-collapse: collapse; " width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr height="30" style="border:#a6107b solid 1px; background-color:#e2f3fd">
                ...
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Reviewed By</b></font></td>
                <!--<td colspan="4" align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Rating</b></font></td>-->
                <td  align="center" style="border:#000000 solid 1px;"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b> Date</b></font></td>
                <!--<td align="left" style="border:#000000 solid 1px;text-indent:5px"><b><font color="#a6107b" size="2" face="Verdana, Arial, Helvetica, sans-serif">Job</font></b></td>-->
                <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#a6107b" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Remarks</b></font></td>
            ...
            while ($row6 = $mysql1->fetch_assoc()) {
                ...
                <tr height="30" style="border:#a6107b solid 1px; background-color:<?php echo $bgcolor ?>">
                    ...
                    <!--<td align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><?php echo $row6['taskname']; ?></b></font></td>-->
                    <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                            <?php echo $row6['remarks']; ?></b></font></td>
                    <td  align="left" style="border:#000000 solid 1px;text-indent:5px"><font color="#0000FF" face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>
                            <?php echo $row6['user_remarks']; ?></b></font></td>
                    <td align="left" style="border:#000000 solid 1px;text-indent:5px">
                        <?php
                        if ($row6['notified'] == 1) {
                            ?>
            ...
            <tr style="border:#a6107b solid 1px;background-color:#ffffff">
                <td  colspan="6" align="center">
                    ...
                    <b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                        ...
                        <input id="obs" type="radio" name="observation" value="1">&nbsp;Observation
                        <input id="ncr" type="radio" name="observation" value="2">N.C.R</font></b></td>
                <td colspan="2" align="center"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> Remarks:</font></b></td>
...
function thisMonth_kpi_audited($user_id, $month, $year) {
    ...
    $sql1 = "SELECT  remarks,action,page_type, DATE_FORMAT( jobdiary_date, '%M' ) month,DATE_FORMAT(log_date,'%d/%m/%Y %h:%i %p') as log_time,u.full_name from tbl_employee_log l left join  tbl_users u on u.user_id=l.user_id  where access_id=$user_id and action = 'KPI Plan Review' and ((MONTH(log_date) = '$month' AND YEAR(log_date) = '$year') || (MONTH(jobdiary_date) = '$month' AND YEAR(jobdiary_date) = '$year')) and l.user_id>0 and access_id!=l.user_id order by date(log_date) DESC limit 10";
