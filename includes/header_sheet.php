...
<tr>
    <td height="25" align="center" valign="middle"><div align="left">
		...
		<td bgcolor="#e9e9e9" width="12%"><a href="admin/jobdiary.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','images/log_rollover.jpg',1)"><img src="images/log.jpg" name="Image1" width="86" height="36" border="0" id="Image1" /></a></td>

		
		<td bgcolor="#e9e9e9" width="14%"><a href="admin/view_reports.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','images/reports_rollover.jpg',1)"><img src="images/reports.jpg" name="Image3" width="104" height="36" border="0" id="Image3" /></a></td>
		...
		<td bgcolor="#e9e9e9" width="12%"><a href="admin/assign_job.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','images/job-over.jpg',1)"><img src="images/job.jpg" name="Image7" width="86" height="36" border="0" id="Image7" /></a></td>
	
		<td bgcolor="#e9e9e9" width="12%"><a href="admin/profile.php?id=<?php	                                       			 echo $_SESSION['user_id'];?>&from=jobdiary.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','images/profile_rollover.jpg',1)"><img src="images/profile.jpg" name="Image4" width="95" height="36" border="0" id="Image4" /></a></td>

		<td bgcolor="#e9e9e9" width="13%"><a href="admin/users.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','images/users_rollover.jpg',1)"><img src="images/users.jpg" name="Image6" width="95" height="36" border="0" id="Image6" /></a></td>
